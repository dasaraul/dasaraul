...
cls
title  IDM JAWA - TAMAENGS STORE %iasver%
...
echo:
echo:
echo:                	Wajib pake IDM versi yang owner kasih     
echo:            ___________________________________________________ 
echo:                                                               
echo:               [1] Bekukan Masa Percobaan
echo:               [2] Aktifkan
echo:               [3] Reset Aktivasi / Masa Percobaan
...
echo:            ___________________________________________________
echo:
call :_color2 %_White% "             " %_Green% "Masukin menu yang dipilih [1,2,3,4,0]"
choice /C:123450 /N
set _erl=%errorlevel%

if %_erl%==6 exit /b
if %_erl%==4 start https://wa.me/6282210819939 & goto MainMenu
